        ...
        <div class="text">
            <div class="div-text p-3">
                ...
                <table class="table table-bordered" id="myTable">
                    <thead>
                        <tr>
                            <th scope="row">manuid</th>
                            <th scope="row">manuname</th>
                            <th scope="row">manu_categoryid</th>
                            <th scope="row">manu_typeid</th>
                            <th scope="row">manu_price</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php while ($row = $query->fetch_assoc()): ?>
                            <tr>
                                ...
                                <td><?php echo $row['manu_typeid']; ?></td>
                                <td><?php echo $row['manu_price']; ?></td>
